###########################################################################
## Makefile generated for component 'HRXDUAL_Delay'. 
## 
## Makefile     : HRXDUAL_Delay.mk
## Generated on : Fri Apr 24 18:19:01 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/HRXDUAL_Delay.out
...
PRODUCT_NAME              = HRXDUAL_Delay
MAKEFILE                  = HRXDUAL_Delay.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2023b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2023b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/pc_ha/Documents/UnityProjects/TrajectoryDelay/SimulinkFiles
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/HRXDUAL_Delay.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/HRXDUAL_Delay_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/inc -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/inc -IC:/ti/CONTRO~1/DEVICE~1/f2806x/v151/F2806X~1/include -IC:/ti/CONTRO~1/DEVICE~1/f2806x/v151/F2806X~4/include -IC:/ti/CONTRO~1//libs/math/CLAmath/v400/include -IC:/ti/CONTRO~1//libs/math/IQmath/v160/include -IC:/ti/CONTRO~1//libs/UTILIT~1/HRCAP_~1/type0/v110/include -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src/ipclite -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/inc/ipclite
...
DEFINES_STANDARD = -DMODEL=HRXDUAL_Delay -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/HRXDUAL_Delay_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/HRXDUAL_Delay_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/HRXDUAL_Delay_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/HRXDUAL_Delay_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/HRXDUAL_Delay_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/HRXDUAL_Delay_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


HRXDUAL_Delay.obj : $(START_DIR)/HRXDUAL_Delay_ert_rtw/HRXDUAL_Delay.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


HRXDUAL_Delay_data.obj : $(START_DIR)/HRXDUAL_Delay_ert_rtw/HRXDUAL_Delay_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_can.obj : $(START_DIR)/HRXDUAL_Delay_ert_rtw/MW_c28xx_can.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


can_datatype_ground.obj : $(START_DIR)/HRXDUAL_Delay_ert_rtw/can_datatype_ground.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/HRXDUAL_Delay_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetInf.obj : $(START_DIR)/HRXDUAL_Delay_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetNaN.obj : $(START_DIR)/HRXDUAL_Delay_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rt_nonfinite.obj : $(START_DIR)/HRXDUAL_Delay_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
